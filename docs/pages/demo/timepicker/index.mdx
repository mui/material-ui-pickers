...
import * as DurationPicker from './DurationPicker.example';
...
You can pick a Unix time in millisecond, which can be used in `setTimeout`.

<Example source={DurationPicker} />
