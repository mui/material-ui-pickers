...
any prop-types, that accept actually the date (e.g. `minDate`, `maxDate`)
can take string, number, Date object and so on.
...
P.S.: Pass any value to the picker, and if it won't be parsed as expected feel free to open issue
on our [github](https://github.com/dmtrKovalenko/material-ui-pickers) 😎
