...
#### Typescript
For [Typescript](https://www.typescriptlang.org) users also required to link the appropriate type for the library, you are using.
You can do this by "/type" module from installed `@date-io` package. It will automatically make pickers to use proper Date type.
